# Workshop: Hugging Face / Spaces

[Hugging Face](https://huggingface.co/) is a platform for open source machine learning models and tools. It provides access to a wide range of models, datasets, and applications where you can experiment with some emerging technologies in artificial intelligence.

It is recommended to open an account, which will give you extended usage limits and more features.

Largely, the website is divided into three sections:
- **Models**: A collection of pre-trained machine learning models that can be used for various tasks such as natural language processing, computer vision, and more.
- **Datasets**: A collection of datasets that can be used for training and evaluating machine learning models.
- **Spaces**: A platform for hosting and sharing machine learning applications and demos.
...
For exploring different new spaces, I recommend a few approaches:
- Using the "shuffle"button inside the search bar to generate random searches (you'll be surprised by what you find!).  
- Using the filter bar to explore spaces by your interests (e.g., "Object Detection", "Background Removal", "Character Animation", etc.).
